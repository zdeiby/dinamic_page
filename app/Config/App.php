...
class App extends BaseConfig
{
     ...
     *    http://example.com/
     */
    public string $baseURL = 'https://comercial.castelancarpinteyro.com';
     ...
     */
    public string $indexPage = ''; // para que no apareza index.php
   // public string $indexPage = 'index.php'; //original
    /**
     * --------------------------------------------------------------------------
     * URI PROTOCOL
     * --------------------------------------------------------------------------
