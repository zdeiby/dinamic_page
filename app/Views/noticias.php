  ...
  <img src="https://www.unidadfamiliamedellin.com.co/unidadfamiliamedellin/resources/img/head.png" width="100%" height="100"  class='pb-2'>
    <div class="row">
      <div class="col-sm-8">
        ...
        <label class="pb-3 elemento-lectura">Creada por: nombre  <?php echo (end($noticias)['created_at']) ?></label>
        <h5 class="text-center pb-3 elemento-lectura"><?php echo (end($noticias)['titulo']) ?> </h5>
